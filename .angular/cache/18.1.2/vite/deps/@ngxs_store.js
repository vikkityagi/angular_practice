...
var _ɵNgxsAppBootstrappedState = class _ɵNgxsAppBootstrappedState extends ReplaySubject {
  constructor() {
    super(1);
  }
  bootstrap() {
...
var _Store = class _Store {
  ...
  selectFromStateStream(observable, selectorFn) {
    return observable.pipe(map(selectorFn), catchError((error) => {
